...
- **All-interfaces binding warns** — `--host 0.0.0.0` is allowed with a startup warning that exposes code-execution-capable APIs to the LAN; use it only on a trusted network.
